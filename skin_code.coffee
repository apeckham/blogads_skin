window.ba_clickable_ad_bg = ->
  ...
  $parent.find("body").prepend """
    <a class="ba_clickable_bg" id="ba_clickable_bg_left" href="#{dfpMacros.clickUrl}" target="_blank"></a>
  """
  $parent.find("#ba_clickable_bg_left").css "left", (ba_contentOffset.left - $parent.find("#ba_clickable_bg_left").width()) + "px"

  $parent.find("body").prepend """
    <a class="ba_clickable_bg" id="ba_clickable_bg_right" href="#{dfpMacros.clickUrl}" target="_blank"></a>
  """
